...
- After ANY correction from the user: update `.claude/instructions/*<topic>*.md` with the pattern
...
6. **Capture Lessons**: Update `.claude/instructions/*<topic>*.md` after corrections
